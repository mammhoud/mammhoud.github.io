...
<img width="80px" class="rounded float-left pe-4" src="https://docs.pytest.org/en/stable/_static/pytest_logo_curves.svg" alt="Pytest logo" onerror="this.src='../img/post/django.jpg'">
